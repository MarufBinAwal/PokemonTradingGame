...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { release_date: @deck.release_date, set_name: @deck.set_name } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { release_date: @deck.release_date, set_name: @deck.set_name } }
